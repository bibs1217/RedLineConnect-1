...
const PRODUCTS: Product[] = [
  { id:'1',  name:'VictoryRevConnect1 Golf Snapback Hat',       price:34.99, category:'Headwear',    image:'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=400&q=85',  desc:'Structured snapback with embroidered logo', badge:'Best Seller' },
  { id:'2',  name:'VictoryRevConnect1 Golf Logo Tee',           price:29.99, category:'Tops',        image:'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=400&q=85',  desc:'Premium cotton tee with VictoryRev logo' },
  { id:'3',  name:'VictoryRevConnect1 Golf Hoodie',             price:64.99, category:'Tops',        image:'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&q=85',  desc:'Fleece pullover hoodie', badge:'New' },
  { id:'4',  name:'VictoryRevConnect1 Golf Cart Sticker Pack',  price:14.99, category:'Accessories', image:'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=400&q=85',  desc:'10-piece vinyl sticker set — weather resistant', badge:'Fan Fav' },
  { id:'5',  name:'VictoryRevConnect1 Golf Tumbler 30oz',       price:39.99, category:'Drinkware',   image:'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=400&q=85',  desc:'Insulated stainless tumbler with lid' },
  { id:'6',  name:'VictoryRevConnect1 Golf Phone Case',         price:24.99, category:'Accessories', image:'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?w=400&q=85',  desc:'Slim protective case for iPhone and Android' },
  { id:'7',  name:'VictoryRevConnect1 Golf Cart Flag',          price:19.99, category:'Accessories', image:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=85',  desc:'12"x18" vinyl flag for golf cart antenna', badge:'New' },
  { id:'8',  name:'VictoryRevConnect1 Golf Keychain',           price:12.99, category:'Accessories', image:'https://images.unsplash.com/photo-1558618047-f9a88cb4f7e1?w=400&q=85',  desc:'Metal keychain with engraved logo' },
  { id:'9',  name:'VictoryRevConnect1 Golf Cooler Bag',         price:44.99, category:'Gear',        image:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=85',  desc:'Insulated cooler bag — fits cart cup holders' },
  { id:'10', name:'VictoryRevConnect1 Golf Seat Cover',         price:54.99, category:'Cart Gear',   image:'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=85',  desc:'Universal fit vinyl seat cover with logo' },
]
    ...
    <div style={{ maxWidth:'1100px', margin:'0 auto', color:'white' }}>
      ...
      <div style={{ background:'linear-gradient(135deg,#1A2940,#06101E)', border:'1px solid rgba(230,57,70,0.1)', borderRadius:'1rem', padding:'2rem', marginBottom:'2rem', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', flexWrap:'wrap', gap:'1rem' }}>
          <div>
            <h1 style={{ fontSize:'2rem', fontWeight:900, marginBottom:'0.4rem' }}>👕 VictoryRevConnect1 Golf Store</h1>
          ...
          <div key={p.id} style={{ background:'#1A2940', borderRadius:'1rem', overflow:'hidden', border:'1px solid rgba(230,57,70,0.08)' }}>
            ...
            <div style={{ height:'220px', position:'relative', overflow:'hidden', background:'#0A1628' }}>
              ...
              <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', background:'rgba(0,0,0,0.6)', borderRadius:'4px', padding:'0.3rem 0.75rem', border:'1px solid rgba(255,255,255,0.25)', pointerEvents:'none' }}>
                <span style={{ color:'white', fontWeight:700, fontSize:'0.85rem', whiteSpace:'nowrap' }}>VictoryRevConnect1 Golf</span>
              </div>
              {p.badge && (
